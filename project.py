...
def fbconnect():
    ...
    url = \
        'https://graph.facebook.com/v2.4/me/picture?%s&redirect=0&'\
...
def editRestaurant(restaurant_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('editRestaurant.html',
                               restaurant_id=restaurant_id, item=editedrest)
...
def deleteRestaurant(restaurant_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('deleteRestaurant.html',
                               restaurant_id=restaurant_id, item=deletedrest)
...
def newMenuItem(restaurant_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        return "<script>function myFunction() {alert('You are not authorized"\
               " to add menu items. Please create your own restaurant in"\
...
def editMenuItem(restaurant_id, menu_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        return "<script>function myFunction() {alert('You are not authorized"\
               ...
               " own restaurant.');}</script><body onload='myFunction()''>"
